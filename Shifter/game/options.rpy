...
init -1 python hide:
    ...
    style.window.background = Frame("images/textbox.png", 5, 5) 
    ...
    # style.mm_menu_frame.xpos = 0.8
    # style.mm_menu_frame.xanchor = 0.8
    # style.mm_menu_frame.ypos = 0.8
    # style.mm_menu_frame.yanchor = 0.8
...
python early:
    config.save_directory = "Carwaii-1445691268"
...
init python:
    ...
    build.directory_name = "Shifter-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Shifter"
