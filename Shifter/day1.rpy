label day1:
  ...
  label treecustomer1:
    ...
    if choice == "charm":
      ...
      if choice == "charm":
        ...
        customer1 '{cps=25}That\'s more like it, I\'d like a dangling die!'
        ...
        volvora '{cps=25}I shall now commence the repairs.{/cps}'
        scene black with bgshow
        play sound "soundeffects/crank.mp3"
        with Pause(5)
        stop sound
  ...
  label treeboxguy1: 
    ...
    if choice == "intelligence":
      if intelligencecount == 0:
        volvaro '{cps=30}You know it\'s getting fairly late, surely you should be...relinquishing yourself from your day\'s labours and heading home to take care of your son now?{/cps}'
        hpunch with flash
        play sound "soundeffects/crash.mp3"
        boxguy '{cps=75}{b}Watch your tone with me little sHquirty or you\'ll be needing a SHesHeSHction of my fisHt tonight!{/b} You think I would ever leave old JHameSH in the dark at home! The boy hasH band practiSH tonight!{/cps}'
        ...
        boxguy '{cps=75}A jife isH masHturbating by the way sHonny. JusHt in casHe you weren\'t down with the lingo. Wife sHtopped putting out a long time ago. MakesH death valley look like the great valley, if you undersHtand what I mean.{/cps}'
        volavro '{cps=25}{i}Dead people do tend to be pretty inefectual in that respect. Looks like you\'re very considerate to that fact.{/cps}'
        $ intelligencecount += 1
        jump treeboxguy1
      else:
      ...
      if choice == "a":
        ...
        boxguy '{cps=75}I sHee, trading me up for a bit of leg over. I can relate, well {b}could{/b}, back when my wife wasHn\'t a complete-{/cps}'
        ...
        boxguy '{cps=50}You got a dog eh? Wouldn\'t figure you for the dog type, not muSH compasHion behind thosHe eyesH. Got more of a cadaverousH look to \'em, sHort of like my good old wife, not sHure if I mentioned but sHe-{/cps}'
        ...
        volvaro '{cps=25}Ooof....oh...{b}yowch!{/b}' with flash
        boxguy '{cps=75}Are you alright lad? I know I mentioned the breakfasHt but thisH isH frankly getting a tad ridiculousH now.{/cps}'
        ...
        boxguy '{cps=75}Wait, I think I know basHic resHursHitation. JusHt lie down and let me take one to five deep inhalesH...{/cps}'
      ...
      boxguy '{cps=50}Go on, take it before I change my mind. ThisH usHed to be JHameSH\'SH when he was a tyke. If you need me jusHt blow and I\'ll come running. I\'ll never forget it\'s dullard tonesH after...well..{/cps}'
      ...
      hide item trumpet
      volvaro '{cps=25}{i}I stuff it in my pocket quickly.{/i}{/cps}'
      volvaro '{cps=25}Thanks...I\'ll make sure to do just that if I ever need....{b}something{/b}.{/cps}'
      boxguy '{cps=50}Good sHtuff lad. JusHt remember to come visHit me onSHe in a while down here, exSHept if it\'sH raining. Can\'t be mesHing about in that sHtuff, need to presHerve my home and all.{/cps}'
  ...
  if choice == "news":
    ...
    volvaro '{cps=25}Cars in a vacuum. This is probably the best thing that\'s ever happened in existence. I should go hire one myself at {a=http://www.rentalcars.com}The Rental Cars Webchannel.{/a} The prices are like suspension...{b}but lower!{/b}{/cps}'
    volvaro '{cps=25}What am I doing here sitting around and moping with myself. I need to get out there and share the joy of {a=http://www.rentalcars.com}RentalCars.com see terms and conditions for details{/a} with the whole world! Life is measured on borrowed time... and now so is your car!!! I can relate {b}so hard!{/b}{/cps}'
    scene black with flash
